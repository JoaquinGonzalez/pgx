...
type NetConn struct {
	...
	// architectures. See BUGS section of https://pkg.go.dev/sync/atomic and https://github.com/JoaquinGonzalez/pgx/issues/1288 and
	// https://github.com/JoaquinGonzalez/pgx/issues/1307. Only access with atomics
